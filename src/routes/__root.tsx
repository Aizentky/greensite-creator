...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sevware Client: dominate PvP with crystal, combat, render and donut modules. 5$/250php download for Minecraft 1.21.1" },
      { name: "author", content: "Sevware" },
      { property: "og:title", content: "Sevware — The Ultimate GHOST  Client" },
      { property: "og:description", content: "Sevware Client: dominate PvP with crystal, combat, render and donut modules. 5$/250php download for Minecraft 1.21.1" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Sevware — The Ultimate GHOST  Client" },
      { name: "twitter:description", content: "Sevware Client: dominate PvP with crystal, combat, render and donut modules. 5$/250php download for Minecraft 1.21.1" },
